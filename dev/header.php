...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'ceylon-blog' ); ?></a>
		<header id="masthead" class="site-header">
			...
			<nav id="site-navigation" class="main-navigation" aria-label="<?php esc_attr_e( 'Main menu', 'ceylon-blog' ); ?>"
				<?php if ( ceylon_blog_is_amp() ) : ?>
			...
			>
				...
				<button class="menu-toggle" aria-label="<?php esc_attr_e( 'Open menu', 'ceylon-blog' ); ?>" aria-controls="primary-menu" aria-expanded="false"
					<?php if ( ceylon_blog_is_amp() ) : ?>
