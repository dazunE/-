...
function ceylon_blog_setup() {
	/*
		...
		* to change 'ceylon-blog' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'ceylon-blog', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'primary' => esc_html__( 'Primary', 'ceylon-blog' ),
		)
	);
	...
	add_theme_support( 'editor-color-palette', array(
		array(
			'name'  => __( 'Dusty orange', 'ceylon-blog' ),
			'slug'  => 'dusty-orange',
			'color' => '#ed8f5b',
		),
		array(
			'name'  => __( 'Dusty red', 'ceylon-blog' ),
			'slug'  => 'dusty-red',
			'color' => '#e36d60',
		),
		array(
			'name'  => __( 'Dusty wine', 'ceylon-blog' ),
			'slug'  => 'dusty-wine',
			'color' => '#9c4368',
		),
		array(
			'name'  => __( 'Dark sunset', 'ceylon-blog' ),
			'slug'  => 'dark-sunset',
			'color' => '#33223b',
		),
		array(
			'name'  => __( 'Almost black', 'ceylon-blog' ),
			'slug'  => 'almost-black',
			'color' => '#0a1c28',
		),
		array(
			'name'  => __( 'Dusty water', 'ceylon-blog' ),
			'slug'  => 'dusty-water',
			'color' => '#41848f',
		),
		array(
			'name'  => __( 'Dusty sky', 'ceylon-blog' ),
			'slug'  => 'dusty-sky',
			'color' => '#72a7a3',
		),
		array(
			'name'  => __( 'Dusty daylight', 'ceylon-blog' ),
			'slug'  => 'dusty-daylight',
			'color' => '#97c0b7',
		),
		array(
			'name'  => __( 'Dusty sun', 'ceylon-blog' ),
			'slug'  => 'dusty-sun',
			'color' => '#eee9d1',
		),
	) );
	...
	add_theme_support( 'editor-font-sizes', array(
		array(
			'name'      => __( 'small', 'ceylon-blog' ),
			'shortName' => __( 'S', 'ceylon-blog' ),
			'size'      => 16,
			'slug'      => 'small',
		),
		array(
			'name'      => __( 'regular', 'ceylon-blog' ),
			'shortName' => __( 'M', 'ceylon-blog' ),
			'size'      => 20,
			'slug'      => 'regular',
		),
		array(
			'name'      => __( 'large', 'ceylon-blog' ),
			'shortName' => __( 'L', 'ceylon-blog' ),
			'size'      => 36,
			'slug'      => 'large',
		),
		array(
			'name'      => __( 'larger', 'ceylon-blog' ),
			'shortName' => __( 'XL', 'ceylon-blog' ),
			'size'      => 48,
			'slug'      => 'larger',
		),
	) );
...
function ceylon_blog_fonts_url() {
	 ...
	 */
	$body_font = esc_html_x( 'on', 'Lato font: on or off', 'ceylon-blog' );
	/**
	 * Translator: If Crimson Text does not support characters in your language, translate this to 'off'.
	 */
	$heading_font = esc_html_x( 'on', 'Playfair Display font: on or off', 'ceylon-blog' );
...
function ceylon_blog_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'ceylon-blog' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'ceylon-blog' ),
...
function ceylon_blog_scripts() {
	...
	wp_localize_script( 'ceylon_blog-navigation', 'ceylon_blogScreenReaderText', array(
		'expand'   => __( 'Expand child menu', 'ceylon-blog' ),
		'collapse' => __( 'Collapse child menu', 'ceylon-blog' ),
	));
