...
function toggleSubMenu( parentMenuItem, forceToggle ) {
	...
	if ( parentMenuItemToggled ) {
		...
		toggleButton.setAttribute( 'aria-label', ceylon_blogScreenReaderText.expand );
		...
		toggleButton.setAttribute( 'aria-label', ceylon_blogScreenReaderText.collapse );
...
function getDropdownButton() {
	...
	dropdownButton.setAttribute( 'aria-label', ceylon_blogScreenReaderText.expand );
